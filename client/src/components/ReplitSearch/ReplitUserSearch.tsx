...
import { AlertCircle, ExternalLink, Search, User, Code, Globe, Calendar, Heart, Eye, GitFork } from "lucide-react";
...
export default function ReplitUserSearch() {
  ...
  const { data: recentSearches = [] } = useQuery<any[]>({
    ...
    enabled: !searchResult, // Only load when not showing search results
  });
